...
struct MusicPlayerInfo gMPlayInfo_5 __attribute__((section("common_data"))) = {};
struct MusicPlayerInfo gMPlayInfo_6 __attribute__((section("common_data"))) = {};
u8 gMPlayMemAccArea[0x10] __attribute__((section("common_data"))) = {};
struct MusicPlayerInfo gMPlayInfo_7 __attribute__((section("common_data"))) = {};
...
u32 MidiKeyToFreq(struct WaveData *wav, u8 key, u8 fineAdjust) {
    ...
    val1 = sScaleTable[key];
    val1 = sFreqTable[val1 & 0xF] >> (val1 >> 4);
    val2 = sScaleTable[key + 1];
    val2 = sFreqTable[val2 & 0xF] >> (val2 >> 4);
...
void SampleFreqSet(u32 freq)
{
    ...
    soundInfo->freq = freq;
    soundInfo->pcmSamplesPerVBlank = sPcmSamplesPerVBlankTable[freq - 1];
...
u32 MidiKeyToCgbFreq(u8 chanNum, u8 key, u8 fineAdjust)
{
    ...
    else
    {
        ...
        val1 = sCgbScaleTable[key];
        val1 = sCgbFreqTable[val1 & 0xF] >> (val1 >> 4);
        val2 = sCgbScaleTable[key + 1];
        val2 = sCgbFreqTable[val2 & 0xF] >> (val2 >> 4);
